...
import { cultureTranslations } from './cultureTranslations';

const resources = {
  'pt-BR': { translation: {
    ...homeTranslations['pt-BR'],
    ...cultureTranslations['pt-BR'],
    ...
    'nav.parades': 'Paradas', 'nav.education': 'Educação', 'nav.about': 'Sobre', 'nav.community': 'Comunidade', 'nav.libras': 'Libras',
    'nav.observatory': 'Observatório', 'nav.farol': 'Farol (IA)', 'nav.opportunities': 'Oportunidades',
  ...
  es: { translation: {
    ...
    'nav.parades': 'Orgullos', 'nav.education': 'Educación', 'nav.about': 'Acerca de', 'nav.community': 'Comunidad', 'nav.libras': 'Libras',
    'nav.observatory': 'Observatorio', 'nav.farol': 'Faro (IA)', 'nav.opportunities': 'Oportunidades',
  ...
  en: { translation: {
    ...
    'nav.parades': 'Prides', 'nav.education': 'Education', 'nav.about': 'About', 'nav.community': 'Community', 'nav.libras': 'Libras',
    'nav.observatory': 'Data', 'nav.farol': 'Farol AI', 'nav.opportunities': 'Opportunities',
