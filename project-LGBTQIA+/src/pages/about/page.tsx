...
const fallbackAbout = {
  ...
  description:
    "A Rede Farol - Portal LGBTQIA+ faz jornalismo de serviço, cultura e acolhimento comunitário para a diversidade no Nordeste do Brasil.",
  image:
...
export default function AboutPage() {
  const { content } = useSiteSection("about-page", fallbackAbout);
    ...
    <main className="w-full bg-white">
      ...
      <section className="relative w-full h-[420px] md:h-[520px]">
        <div
          ...
          style={{
            backgroundImage: `url("${content.image || fallbackAbout.image}")`,
          }}
        />
