...
import { allArticles, categoryLabels } from '@/mocks/articles-full';
            ...
            <div className="flex-1 min-w-0">
              ...
              {gridArticles.length > 0 ? (
                ...
                <div className="text-center py-16">
                  ...
                  <h3 className="text-lg font-medium text-dark-600">Nenhum artigo encontrado</h3>
                  <p className="mt-1 text-sm text-dark-400">Tente ajustar os filtros ou termos de busca.</p>
                </div>
              )}
