...
const pages: Record<string, PolicyPage> = {
  '/politica-editorial': {
    ...
    intro: 'Esta política explica como escolhemos, produzimos, revisamos e atualizamos conteúdos do Portal LGBTQ+ Nordeste.',
    updated: '15 de julho de 2026',
    sections: [
      { title: 'Nossa missão', paragraphs: ['Produzimos informação de interesse público, serviço e cultura para pessoas LGBTQ+ no Nordeste, com linguagem acessível, respeito à diversidade e atenção ao contexto regional. Publicamos para informar, ampliar direitos e fortalecer redes de cuidado — nunca para gerar medo ou substituir serviços profissionais.'] },
  ...
  '/nossas-fontes': {
    eyebrow: 'Metodologia',
    title: 'Nossas fontes',
    intro: 'Veja quais fontes priorizamos e como documentos, dados e entrevistas são usados nos conteúdos.',
    updated: '15 de julho de 2026',
    sections: [
  ...
  '/politica-de-correcoes': {
    ...
    updated: '15 de julho de 2026',
    sections: [
      { title: 'Como solicitar uma correção', paragraphs: ['Envie um e-mail para contato@portallgbtq.com.br com o assunto “Correção”, incluindo o endereço da página, o trecho questionado, a justificativa e, se possível, documentos que sustentem a solicitação. Não envie dados pessoais sensíveis que não sejam indispensáveis.'] },
  ...
  '/contato': {
    ...
    title: 'Contato',
    intro: 'Use nossos canais para pautas, correções, parcerias responsáveis e dúvidas sobre o portal.',
    updated: '15 de julho de 2026',
    sections: [
      { title: 'E-mail', paragraphs: ['Escreva para contato@portallgbtq.com.br. Para agilizar a triagem, use no assunto: “Pauta”, “Correção”, “Privacidade”, “Parceria” ou “Problema técnico”.'] },
  ...
  '/privacidade': {
    ...
    sections: [
      ...
      { title: 'Seus direitos', paragraphs: ['Você pode pedir confirmação de tratamento, acesso, correção ou exclusão quando aplicável. Envie a solicitação para contato@portallgbtq.com.br com o assunto “Privacidade”. Podemos solicitar confirmação de identidade para proteger seus dados.'] },
  ...
  '/termos-de-uso': {
    ...
    sections: [
      ...
      { title: 'Contribuições de usuários', paragraphs: ['Ao enviar conteúdo, você declara ter autorização para fazê-lo. O portal pode moderar, editar, rejeitar ou remover contribuições para proteger a comunidade e cumprir esta política, sem obrigação de publicação.'] },
        ...
        <div className="mt-8 rounded-2xl border border-dark-100 bg-white p-6 md:p-10">
          ...
          {pathname === '/contato' && (
            <div className="mt-10 flex flex-wrap gap-3 border-t border-dark-100 pt-8">
              <a href="mailto:contato@portallgbtq.com.br" className="rounded-full bg-primary-500 px-6 py-3 text-sm font-semibold text-white hover:bg-primary-600">
                Enviar e-mail
              </a>
              <Link to="/sos" className="rounded-full border border-red-200 px-6 py-3 text-sm font-semibold text-red-700 hover:bg-red-50">
